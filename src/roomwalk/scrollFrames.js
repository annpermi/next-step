...
export default class ScrollFrames {
  constructor({
    ...
    // Скролл-промотку кадров вестибулярным движением не считаем: ею управляет
    // сам пользователь. Для героя это надо оставлять включённым и при
    // prefers-reduced-motion, иначе секция просто стоит.
